...
public class UtilityClass {
	...
	public static String enterWebelement(String arg) {
	...
	public static void selectDropDowen(WebElement element, String text) {
	...
	public static String readFromExcel(String text, int rowNo, int cellNo) throws IOException {
		...
		File f = new File(
				"C:\\Users\\ranji\\eclipse-workspace\\DemoWebshopSudoboat\\Data\\DemoWebshopData.xlsx");
